...
exports.default = (0, _create2.default)({
  render: function render() {
    ...
    })], 2)]), _c('div', { ref: "content", staticClass: "van-tabs__content" }, [_vm._t("default")], 2)]);
  },
  ...
  methods: {
    ...
    swipeableHandler: function swipeableHandler(init) {
      ...
      (init ? _event.on : _event.off)(swipeableEl, 'touchstart', this.onTouchStart, false);
      (init ? _event.on : _event.off)(swipeableEl, 'touchmove', this.onTouchMove, false);
      (init ? _event.on : _event.off)(swipeableEl, 'touchend', this.onTouchEnd, false);
      (init ? _event.on : _event.off)(swipeableEl, 'touchcancel', this.onTouchEnd, false);
    },
