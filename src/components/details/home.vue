  ...
  <div style="width:100%">
    ...
    <div class="home_wrap" >
      ...
      <div v-if="showList" style="padding-bottom: 1.7rem">
        ...
        <div class="home_address">回收地址<router-link to="adressList"><div class="add reaonly">{{adressList
          .address?adressList.address:''}}{{adressList.houseNumber}}</div></router-link><img
          src="@/assets/icon_right.png" alt=""></div>
        <div class="home_call">
          <h3>分类回收 助力绿色环保</h3>
          <ul class="home_list">
